                                ...
                                html.Div([
                                    ...
                                    html.Div([
                                        ...
                                        dcc.Dropdown(id='input-type',
                                                    ...
                                                    style={'width': '80%', 'fontsize': '20px', 'padding': '3px', 'text-align-last': 'center'}
                                                    )
...
if __name__ == '__main__':
    ...
    app.run_server(host="localhost", port=8010, debug=False, dev_tools_ui=False, dev_tools_props_check=False)
